...
public :
  ...
  GLWindow(
	...
	void stopSimTimer();
    //--------------------------------------------------------------------------------------
    /// @brief update the cloth
    //-----------------------------------------------------------------------------------------
    void clothUpdate(ngl::ShaderLib *_shader,ngl::TransformStack &_transformStack,ngl::Camera *_cam);
public slots :
	//----------------------------------------------------------------------------------------------------------------------
...
private :
  ...
  ngl::TransformStack m_transformStack;
    ...
    RK4Spring *m_spring;
    //----------------------------------------------------------------------------------------------------------------------
    /// @brief our cloth pointer
    //----------------------------------------------------------------------------------------------------------------------
    Cloth *m_cloth;
    //----------------------------------------------------------------------------------------------------------------------
    /// @brief setup the wind direction
    //----------------------------------------------------------------------------------------------------------------------
